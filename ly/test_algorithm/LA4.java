 ...
 */
public class LA4 extends GridSim{
	...
	public LA4(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			LA4 user0=new LA4("User_0", 560.00, total_resource);
			LA4 user1=new LA4("User_1", 560.00, total_resource);
			LA4 user2=new LA4("User_2", 560.00, total_resource);
