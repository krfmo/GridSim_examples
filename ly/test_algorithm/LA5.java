 ...
 * 关于学习自动机的仿真模拟
 * 任务长度按高斯分布，利用了文章中的公式
 * 任务分为长短两种，设置一个参数常量，长短任务比例
 * 争取用上文章里的公式，将得到的两个参数融入到公式中
 */
public class LA5 extends GridSim{
	...
	public LA5(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			LA5 user0=new LA5("User_0", 560.00, total_resource);
			LA5 user1=new LA5("User_1", 560.00, total_resource);
			LA5 user2=new LA5("User_2", 560.00, total_resource);
