 ...
 * 注意：最好能将机器按计算能力排序
 */
public class LA3 extends GridSim{
	...
	public LA3(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			LA3 user0=new LA3("User_0", 560.00, total_resource);
			LA3 user1=new LA3("User_1", 560.00, total_resource);
			LA3 user2=new LA3("User_2", 560.00, total_resource);
