 ...
 * 资源处理能力差异	37，39，41
 */
public class Test21 extends GridSim{
	...
	public static final int GAUSSIAN_CONST_2=100000;//长任务
	//长短任务比例，0的短任务，1的长任务吧
	...
	private int[] glLengths={99451, 99775, 99689, 99420, 99984, 100337, 99590, 99544, 100065, 99791,
			100044, 100094, 99865, 99997, 99712, 99914, 99673, 99855, 99687, 100100, 100045, 99815, 
			100708, 100077, 100356, 100227, 100666, 99901, 100405, 100341, 99461, 99472, 100291, 
			100433, 100035, 99961, 99885, 99462, 99839, 100957, 99668, 100384, 99918, 100465, 100895,
			100063, 100126, 99984, 99835, 99837, 100343, 100503, 100087, 99826, 99714, 99996, 100105,
			99538, 99676, 100280, 100126, 100109, 99944, 99249, 99851, 100811, 99472, 100078, 100043,
			100062, 100080, 99860, 99784, 99259, 99751, 100386, 99585, 100016, 100146, 100492, 100504,
			99722, 100260, 100251, 99853, 99606, 99900, 100548, 100530, 99813, 100685, 100973, 99853,
			100334, 99698, 100401, 99470, 100147, 99883, 100220};

	public Test21(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test21 user0=new Test21("User_0", 560.00, total_resource);
			Test21 user1=new Test21("User_1", 560.00, total_resource);
			Test21 user2=new Test21("User_2", 560.00, total_resource);
