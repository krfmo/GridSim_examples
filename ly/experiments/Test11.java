 ...
 * 资源处理能力差异	30，40，50
 */
public class Test11 extends GridSim{
	...
	private int[] glLengths={10587, 15921, 19494, 14346, 14708, 19344, 18637, 17944, 13813, 14367,
			11293, 12228, 13401, 11027, 19936, 17422, 13290, 19127, 14168, 17276, 13060, 17847, 16807,
			15484, 11841, 12898, 14830, 13440, 13124, 14695, 12678, 18119, 16185, 16677, 10221, 13929,
			12561, 11956, 11533, 11580, 10728, 16757, 11743, 12602, 10023, 15559, 12190, 17070, 11684,
			12308, 15660, 19882, 14661, 13473, 16200, 15600, 15215, 15604, 11217, 18123, 18633, 16792,
			17958, 11729, 15044, 18848, 10611, 16257, 18339, 11991, 18986, 17448, 17957, 13556, 15266,
			17056, 12407, 12483, 12130, 10600, 18371, 19003, 19639, 19264, 10272, 12095, 14904, 16118,
			13504, 17587, 13186, 15965, 10439, 19317, 13715, 11315, 12783, 14011, 18200, 14832};

	public Test11(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test11 user0=new Test11("User_0", 560.00, total_resource);
			Test11 user1=new Test11("User_1", 560.00, total_resource);
			Test11 user2=new Test11("User_2", 560.00, total_resource);
