 ...
 * 资源处理能力差异	37，39，41
 */
public class Test22 extends GridSim{
	...
	public static final int GAUSSIAN_CONST_2=100;//长任务
	//长短任务比例，0的短任务，1的长任务吧
	...
	private int[] glLengths={111, 83, 89, 92, 70, 118, 114, 100, 93, 108, 101, 100, 128, 107, 96, 103,
			95, 100, 88, 75, 102, 99, 104, 95, 97, 102, 101, 88, 98, 92, 100, 92, 94, 83, 82, 101, 107,
			106, 89, 117, 93, 84, 114, 108, 95, 112, 92, 117, 104, 88, 107, 106, 101, 103, 92, 96, 112,
			112, 93, 98, 96, 94, 96, 85, 83, 91, 106, 98, 102, 90, 93, 91, 93, 104, 90, 122, 123, 110,
			105, 90, 101, 97, 107, 96, 95, 94, 81, 104, 84, 94, 108, 79, 89, 112, 96, 120, 114, 97,
			103, 99};

	public Test22(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test22 user0=new Test22("User_0", 560.00, total_resource);
			Test22 user1=new Test22("User_1", 560.00, total_resource);
			Test22 user2=new Test22("User_2", 560.00, total_resource);
