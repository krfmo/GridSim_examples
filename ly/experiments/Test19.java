 ...
 * 资源处理能力差异	37，39，41
 */
public class Test19 extends GridSim{
	...
	public Test19(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test19 user0=new Test19("User_0", 560.00, total_resource);
			Test19 user1=new Test19("User_1", 560.00, total_resource);
			Test19 user2=new Test19("User_2", 560.00, total_resource);
