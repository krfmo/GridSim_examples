 ...
 * 资源处理能力差异	30，40，50
 */
public class Test15 extends GridSim{
	...
	public Test15(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test15 user0=new Test15("User_0", 560.00, total_resource);
			Test15 user1=new Test15("User_1", 560.00, total_resource);
			Test15 user2=new Test15("User_2", 560.00, total_resource);
