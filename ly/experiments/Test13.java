 ...
 * 资源处理能力差异	37，39，41
 */
public class Test13 extends GridSim{
	...
	private int[] glLengths={17488, 12890, 13721, 18027, 14297, 18214, 10240, 11585, 19998, 12451, 19908,
			18388, 14629, 15726, 12270, 10570, 11536, 16929, 11987, 16024, 14419, 19008, 12911, 18776,
			10171, 14121, 19408, 10464, 15881, 16837, 18632, 14643, 14886, 12236, 13064, 15763, 12728,
			17271, 11543, 18912, 15080, 18536, 11193, 19802, 13372, 18475, 12051, 17663, 19549, 11425,
			12096, 18878, 13828, 14376, 12866, 10696, 18615, 15582, 15449, 11755, 19158, 17989, 11616,
			12608, 13702, 16805, 19278, 17280, 19595, 19151, 17811, 18817, 12846, 10352, 16970, 12260,
			17292, 10281, 17227, 14759, 18998, 18848, 15625, 14110, 18439, 11914, 11550, 16906, 14283,
			17726, 17737, 15233, 15802, 12669, 10237, 16642, 15604, 16959, 15816, 12504};

	public Test13(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test13 user0=new Test13("User_0", 560.00, total_resource);
			Test13 user1=new Test13("User_1", 560.00, total_resource);
			Test13 user2=new Test13("User_2", 560.00, total_resource);
