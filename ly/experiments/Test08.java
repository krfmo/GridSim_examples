...
public class Test08 extends GridSim{
	...
	private int[] glLengths={129, 14261, 11333, 100, 170, 187, 180, 181, 171, 145,
			106, 10465, 10380, 184, 157, 17543, 17029, 186, 148, 13061, 106, 124,
			11845, 17331, 17615, 18161, 109, 12987, 10925, 11767, 185, 115, 147, 137,
			136, 12299, 17166, 10095, 104, 165, 190, 14672, 148, 152, 10887, 177, 107,
			18187, 12390, 11454, 129, 198, 169, 10322, 128, 143, 11049, 145, 166, 146,
			17014, 14916, 150, 14491, 15481, 16684, 19780, 17623, 12672, 16677, 158, 142,
			171, 182, 18138, 108, 109, 118, 141, 147, 19174, 119, 185, 174, 109, 119, 19644,
			133, 12727, 17309, 137, 138, 174, 140, 150, 18918, 164, 115, 157, 13227};
	...
	public static void main(String[] args) {
		...
		try{
			...
			//GridResource resource3=createGridResource("Resource3", MIPS_RATING_4, "Sun Ultra", "Solaris");
