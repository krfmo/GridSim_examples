 ...
 * 资源数	3
 * 资源处理能力差异	标准差为6.97
 * 各个机器处理能力分别为:31，41，48
 */
public class Test08 extends GridSim{
	...
	public static final int MIPS_RATING_1=31;
	public static final int MIPS_RATING_2=41;
	public static final int MIPS_RATING_3=48;
	...
	private int[] glLengths={9960, 10026, 10134, 9838, 10212, 10066, 9951, 9950, 9964, 9960, 9943, 10071,
			9899, 9822, 10050, 10036, 9841, 9854, 9915, 10027, 9939, 9949, 10117, 10021, 10151, 10060,
			10121, 9967, 10004, 10070, 10133, 10080, 9988, 9768, 9941, 10019, 9957, 10247, 10117, 9954,
			9949, 10014, 9801, 9957, 9913, 10152, 9939, 9904, 9971, 10012, 10081, 10006, 9872, 10210,
			10078, 9993, 9917, 10014, 10024, 9971, 10095, 10298, 9786, 10082, 10049, 9905, 9836, 9957,
			10069, 9940, 9977, 10048, 10005, 9954, 10120, 10037, 9954, 10087, 9841, 10049, 9878, 10013,
			10098, 9925, 9909, 9958, 9979, 9932, 9920, 9935, 10042, 10007, 9909, 9963, 10088, 10153,
			10026, 9998, 10100, 10081};

	public Test08(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test08 user0=new Test08("User_0", 560.00, total_resource);
			Test08 user1=new Test08("User_1", 560.00, total_resource);
			Test08 user2=new Test08("User_2", 560.00, total_resource);
