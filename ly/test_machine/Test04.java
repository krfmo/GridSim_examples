 ...
 * 资源数	3
 * 资源处理能力差异	标准差为2.94
 * 各个机器处理能力分别为:36，41，43
 */
public class Test04 extends GridSim{
	...
	public static final int MIPS_RATING_1=36;
	public static final int MIPS_RATING_2=41;
	public static final int MIPS_RATING_3=43;
	...
	private int[] glLengths={10191, 10027, 10124, 9984, 10121, 9923, 9925, 9805, 9915, 9992, 9875, 9918,
			9815, 10156, 9943, 9783, 10031, 10004, 9888, 10040, 10094, 9964, 9935, 10055, 9943, 9830,
			10174, 10127, 10007, 9998, 10066, 10109, 9972, 9999, 9932, 10036, 9911, 10112, 10121, 10091,
			10003, 10178, 10148, 10023, 10086, 9754, 9920, 10032, 10034, 10062, 10026, 9870, 10173, 9969,
			10050, 10195, 10126, 10084, 10011, 9976, 9890, 10009, 10094, 10094, 9924, 10079, 10051, 9934,
			9972, 10096, 9707, 10014, 9901, 10017, 9920, 9889, 9758, 10076, 10037, 10077, 10078, 9898,
			10086, 10075, 10122, 10223, 10037, 9975, 10026, 10084, 10088, 9884, 10033, 10047, 10127, 9946,
			10152, 9937, 10027, 9927};

	public Test04(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test04 user0=new Test04("User_0", 560.00, total_resource);
			Test04 user1=new Test04("User_1", 560.00, total_resource);
			Test04 user2=new Test04("User_2", 560.00, total_resource);
