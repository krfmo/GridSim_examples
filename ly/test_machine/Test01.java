 ...
 * 资源数	3
 * 资源处理能力差异	标准差为0
 * 各个机器处理能力分别为:40，40，40
 */
public class Test01 extends GridSim{
	...
	public static final int MIPS_RATING_1=40;
	public static final int MIPS_RATING_2=40;
	public static final int MIPS_RATING_3=40;
	...
	private int[] glLengths={10023, 9962, 10038, 10009, 9984, 10098, 9826, 10038, 9873, 10052, 9868, 9782,
			9979, 9963, 9949, 10165, 9922, 9971, 10207, 9996, 9692, 9986, 9967, 9974, 9961, 10127, 10021,
			10089, 9949, 9897, 10064, 9952, 10063, 9962, 9808, 9837, 10014, 9842, 10050, 10003, 10006, 10047,
			10079, 10178, 10163, 10093, 9970, 9794, 9953, 10050, 10240, 10116, 9732, 9894, 9898, 9905, 10095,
			9923, 10099, 10096, 9937, 10027, 10026, 10073, 10220, 9981, 9941, 9992, 10044, 9954, 9975, 9987,
			9942, 9976, 10055, 10001, 10115, 10222, 10068, 10138, 9895, 9999, 10103, 10099, 10126, 10154,
			9930, 9919, 10060, 10060, 9883, 9938, 9981, 9918, 9930, 10065, 9932, 10018, 9975, 10007};

	public Test01(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test01 user0=new Test01("User_0", 560.00, total_resource);
			Test01 user1=new Test01("User_1", 560.00, total_resource);
			Test01 user2=new Test01("User_2", 560.00, total_resource);
