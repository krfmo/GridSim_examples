 ...
 * 资源数	3
 * 资源处理能力差异	标准差为8.16
 * 各个机器处理能力分别为:30，40，50
 */
public class Test09 extends GridSim{
	...
	private int[] glLengths={10111, 10033, 10034, 10182, 9937, 9911, 10000, 10051, 9875, 9828, 9954,
			10004, 9990, 9897, 10111, 10013, 10179, 10096, 10027, 10002, 10035, 10208, 9910, 10035,
			10130, 10039, 9894, 9938, 9767, 9922, 9896, 10013, 10033, 9911, 10139, 9884, 10058, 9882,
			10106, 10083, 9917, 10007, 9995, 9997, 10096, 10122, 10136, 9983, 10051, 9958, 10043, 9930,
			9990, 10244, 9970, 9976, 9846, 10062, 9937, 9937, 9843, 10053, 9821, 9941, 10149, 9916,
			10052, 9930, 9985, 10068, 9883, 10114, 9972, 9942, 9939, 9921, 10041, 10064, 10037, 10046,
			10198, 10113, 9945, 9939, 10021, 10033, 10005, 10072, 9899, 9829, 10123, 9880, 10098, 10122,
			9837, 9918, 10020, 9875, 9953, 9940};

	public Test09(String name, double baudRate, int totalResource) throws Exception {
		super(name, baudRate);
		this.name_=name;
	...
	public static void main(String[] args) {
		...
		try{
			...
			Test09 user0=new Test09("User_0", 560.00, total_resource);
			Test09 user1=new Test09("User_1", 560.00, total_resource);
			Test09 user2=new Test09("User_2", 560.00, total_resource);
