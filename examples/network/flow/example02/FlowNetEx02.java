    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            for (i = 0; i < num_user; i++)
            {
                ...
                FlowNetUser user = new FlowNetUser(name, totalGridlet, baud_rate,
            ...
            for (i = 0; i < userList.size(); i++)
            {
                ...
                obj = (FlowNetUser) userList.get(i);
            ...
            // For each host, specify which PacketScheduler entity to use.
            baud_rate = 10000;
            Link link = new FlowLink("r1_r2_link", baud_rate, propDelay, Integer.MAX_VALUE);
                ...
                double baud_rate, double delay, int MTU)
    {
        ...
        try
        {
            ...
            gridRes = new GridResource(name,
                new FlowLink(name + "_link", baud_rate, delay, MTU),
